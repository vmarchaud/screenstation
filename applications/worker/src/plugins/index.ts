...
import * as viewPlugin from './views'
import * as metaPlugin from './meta'
import * as castPlugin from './cast'
import * as refreshPlugin from './refresh'
import * as streamPlugin from './stream'
